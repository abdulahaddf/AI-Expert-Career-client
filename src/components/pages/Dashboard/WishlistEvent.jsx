  ...
  const noramlWish = [
    {
      ...
      details:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. At, voluptatem tempore. Harum consectetur nemo exercitationem ducimus voluptatem porro alias accusamus.",
    },
    {
      Image: basiWisht,
      title: "The Glamourous Life",
        ...
        {noramlWish.map((wish, i) => (
          <>
            <div key={i} className="flex relative">
              ...
              <div>
                <button className="text-xs right-0 top-2 absolute text-[#ED1B24]">
                  <BsXCircle />
                </button>
                <h3 className="font-medium mt-5">{wish.title}</h3>
                <p className="text-xs mt-2.5 text-black/70">
                  {wish.details.slice(0, 60)}
                  <span className="text-[#ED1B24] text-xs font-bold">
                    ...See More
                  </span>
                </p>
              </div>
            ...
            <>
              <div key={i} className="flex relative">
                <img
                  src={image}
                  alt=""
                  className="mr-3 md:w-3/4 md:h-3/4 xl:w-full xl:h-full"
                />
                <div className="w-full mr-[8px]">
                  <button className="text-xs right-4 top-2 absolute text-[#ED1B24]">
                    <BsXCircle />
                  </button>
                  ...
                  <div className=" w-full">
                    <p>${price}</p>
                    <button className="py-1 px-2 bg-[#ED1B24] rounded-full text-white md:font-medium text-xs md:text-sm my-btn">
                      Add to cart
                    </button>
                  </div>
                </div>
