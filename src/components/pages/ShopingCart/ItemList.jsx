    ...
    <div className="md:ml-4">
      <div className="flex justify-between text-xl font-semibold border-b border-black pb-3">
        <h4 className=" text-center md:text-left">
          {language == "bn" ? "সংগ্রহের তালিকা" : "Item List"}
        </h4>
      ...
      <div className="mt-5">
            ...
            <div className="flex space-x-4">
              <div className="relative">
                ...
                <div
                  ...
                  className="h-3 w-3 bg-black absolute flex justify-center items-center -top-1 -right-1 rounded-full"
                >
        ...
        <button
          onClick={() => setItems([])}
          className="font-semibold py-3 px-7 bg-[#FF0944] rounded text-white mt-9"
        >
