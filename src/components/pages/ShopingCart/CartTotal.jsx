    ...
    <div>
      ...
      <div className="w-[371px] bg-[#F4F4FC] p-8 mt-10">
        ...
        <div className="flex items-center mt-7 ">
          ...
          <p
            onClick={() => setValid(!valid)}
            className="text-xs cursor-pointer read-only"
          >
        ...
        <div className="mt-8">
          <Link to={"/payment"}>
            <button
              ...
              className="py-[13px] w-full rounded bg-[#FF0944] text-white text-sm font-bold"
            >
              {language == "bn" ? "পেমেন্ট নিশ্চিত করুন" : "Confirm the order"}
            </button>
          </Link>
        </div>
      </div>
