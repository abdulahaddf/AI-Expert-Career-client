...
const EventDetails = () => {
  ...
  return (
    <div className="grid md:grid-cols-2 mt-12 gap-12">
      <div className="">
        <h1 className="text-[#000000] text-[30px] font-bold">
          {language == "bn" ? "ইভেন্টের বিবরণ" : "Event Details"}
        </h1>
        <p>
          {language == "bn"
      ...
      <div className="">
        <form className="bg-white p-10">
          ...
          <br />
          <input
            className="border-b-2 border-[gray] w-full "
            type="text"
            placeholder={
              language == "bn" ? "আপনার পুরো নাম*" : "enter your name"
            }
          />{" "}
          <br />
          <input
            className="border-b-2 border-[gray] w-full mt-9"
            type="email"
            placeholder={
              language == "bn" ? "আপনার ইমেইল এড্রেস*" : "enter your email"
            }
          />{" "}
          <br />
          <input
            className="border-b-2 border-[gray] w-full mt-9 text-[#ED1B24]"
            type="tell"
            placeholder={language == "bn" ? "ফোন নাম্বার *" : "mobile number"}
          />{" "}
          <br />
          <input
            className="border-b-2 border-[gray] w-full mt-9"
            type="password"
            placeholder={
              language == "bn" ? "আপনার পাসওয়য়ার্ড দিন*" : "enter your password"
            }
          />{" "}
          <br />
