      ...
      <div className="md:grid hidden md:grid-cols-3 md:mt-[-150px] mt-[-200px]">
        <div className="col-span-2 relative bg-[white] p-8 md:rounded-l-3xl md:h-auto h-[370px] ">
          <img
            ...
            alt=""
          />
          <h1 className="text-3xl text-[#FF003D] font-bold">
            {eventData.title}
          </h1>
          <br />
          <div className="flex justify-between items-end">
            <div className="">
              <span className="flex item-center gap-2  mt-2 font-bold text-[#525252]">
                <MdAccessAlarms className="text-[18px] text-[#FE0C0C]" /> Date
                and time
              </span>
              <p className="text-[#3753E8] font-bold text-[20px] mt-1">
                {eventData.date}
              </p>
            </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-[#3753E8] font-bold text-xl mt-1">
              {eventData.address}
            </p>
          </div>
        ...
        <div className="bg-[white]  p-8 md:rounded-r-3xl  border-l-2 border-dashed relative border-[black] ">
          ...
          <img
            src={eventData?.holderInfo?.img}
            className="w-[80px] h-[80px] rounded-[22px] m-auto"
            alt=""
          />
          <br />
          <h2 className="md:text-2xl font-bold text-[20px] text-center text-[#000000]">
            {eventData.holderInfo.name}
          </h2>
          <p className="text-center text-[gray] text-[13px]">
            patmitchelle@example.com
          </p>
          <ul>
      ...
      <div className="block md:hidden  md:mt-[-150px] mt-[-90px]">
        <div className="col-span-2 relative bg-[white] rounded-2xl p-8 md:rounded-l-3xl md:h-auto h-[400px] ">
          <img
            ...
            alt=""
          />
          <h1 className="md:text-3xl text-xl text-[#FF003D] font-bold">
            EVENT NAME HEADING
          </h1>
          <br />
          <div className="flex justify-between items-end">
            <div className="">
              ...
              <p className="text-[#3753E8] font-bold md:text-[20px] mt-1">
                Sunday, 20feb 2023
              </p>
            </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-[#3753E8] font-bold md:text-xl mt-1">
              Mirpur, Dhaka
            </p>
          </div>
