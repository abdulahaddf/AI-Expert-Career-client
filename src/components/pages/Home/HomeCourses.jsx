      ...
      <ul className="flex justify-center md:hidden flex-wrap  lg:border-b-2 lg:border-black w-full items-center lg:gap-3 gap-4">
        <li>
          <button
            ...
            className={`${
              active === "ai"
                ? "py-[14px] bg-[#ff013c] text-white px-3  rounded font-bold text-[#FF0944]/80 h-full "
                : "pending bg-[#ffc5d3] rounded-lg text-black hover:bg-[#EF7794]/30 md:bg-transparent py-[14px] px-3 "
            }`}
          >
        ...
        <li>
          <button
            ...
            className={`${
              active === "web"
                ? "py-[14px] bg-[#ff013c] text-white px-3  rounded font-bold text-[#FF0944]/80 h-full  "
                : "pending bg-[#ffc5d3] rounded-lg text-black hover:bg-[#EF7794] md:bg-transparent py-[14px] px-3"
            }`}
          >
      ...
      <ul className="md:flex hidden items-center flex-wrap justify-center lg:gap-x-16">
        <li>
          <button
            ...
            className={`py-[14px] text-black px-3  rounded-t font-bold h-full ${
              active === "all"
                ? "bg-[#ff003c] text-white"
                : "pending bg-[#EF7794]/10 hover:bg-[#f2396493]  hover:text-black md:bg-transparent py-[14px] px-3"
            }`}
          >
            {language === "bn" ? "সকল কিছু" : "All"}
          </button>
  ...
  return (
    <div className="mt-[80px] mb-[35px] py-[14px]">
      <h3 className="text-center font-bold text-[30px]">
        {language === "bn"
          ? "ফ্রি কোর্স সহ পাচ্ছেন বিভিন্ন বিষয়ের লাইভ কোর্স"
          : "Live courses on various subjects are available along with free courses"}
      </h3>
      ...
      <div className="mt-[19px] h-10 lg:h-14 ">
        <ul className="items-center lg:border-b-2 lg:border-[#B7B7B7] text-sm lg:text-[18px] lg:font-[700] flex ">
          {menuItem}
        </ul>
      </div>
        ...
        {aboutCard
          ...
          .map(({ id, img, headline, info, price }) => (
            ...
            >
              ...
              <div className="">
                <h3 className="text-lg font-bold md:mb-[8px]">{headline}</h3>
                <p className="md:mb-[20px] mb-2 text-sm">
                  {info.slice(0, 100)}
                </p>
      ...
      {aboutCard.length == 0 ? (
        <h2 className="text-lg font-bold text black text-center ">0 item</h2>
      ) : (
        <center>
          <Link to="/courses">
