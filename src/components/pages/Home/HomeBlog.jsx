  ...
  return (
    <div className="mt-[80px] mb-[35px] relative">
      <h3 className="text-center font-bold text-[30px]">
        {language === "bn"
          ? "কৃত্রিম বুদ্ধিমত্তা সম্পর্কে পড়ুন"
          : "Read About Artificial Intelligent"}
      </h3>
      <center>
        <img
          src={line}
      ...
      <p className="sm:w-[50%] mx-auto text-center mt-4 mb-[25px] text-[21px] font-bold">
        {language === "bn"
          ? "আপনি যেকোনো বেকগ্রাউন্ডের স্টুডেন্ট বা লার্নার হোন না কেনো, সঠিক রোডম্যাপ পারে আপনাকে আপনাকে পৌছেদিতে পারে সফলতার শীর্ষে। আমাদের এ আই রোডম্যাপ এবং কনসাল্টেন্সি সার্ভিস বিভিন্ন এ এই এক্সপার্টদের দ্বারা তৈরি করা"
      ...
      <div className="my-16 grid grid-cols-2 lg:w-[60%] mx-auto text-[22px] font-bold">
        <button
          className={`border-2 border-[#000] py-[10px] ${
            activeButton === "Blog"
      ...
      <div className=" flex lg:hidden">
        <RiMenu2Fill
          ...
          className={!menu ? "text-2xl " : "hidden"}
        ></RiMenu2Fill>
        <RiMenu4Line
      ...
      <div
        className={
          menu
            ? "items-center lg:hidden flex-wrap px-10 lg:text-[18px] font-[700] flex gap-16"
            : "hidden"
        }
      >
        {menuItem}
                ...
                <div className="">
                  ...
                  <div className="flex justify-between items-center ">
                    <Link to={`/individual-blog/${id}`}>
                      <button className="md:px-[32px] px-2 text-[10px] md:text-lg py-1 md:py-[8px] bg-[#ED1B24] my-btn rounded-md text-white shadow-lg">
                        {" "}
                ...
                <div className="">
                  ...
                  <div className="flex justify-between items-center gap-6">
                    <Link to={`/individual-case-study/${id}`}>
                      <button className="px-[32px] py-[8px] bg-[#ED1B24] my-btn rounded-md text-white shadow-lg">
                        {" "}
                        {language === "bn" ? "পড়ুন" : "Read"}
                      </button>
                    </Link>
