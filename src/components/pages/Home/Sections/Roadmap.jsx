  ...
  return (
    <div className="relative md:mb-10 pt-20 py-10 md:py-0">
      ...
      <div className="absolute top-0 md:top-5 md:w-5/12 w-4/5 mx-auto md:space-y-4 md:ml-10">
        ...
        <Link to='/ai-consultant' className="btn-black btn-sm md:btn-md md:btn-view flex items-center w-fit"> {language == "bn" ? "ক্যারিয়ার শুরু করুন" : "Start Your Career"}<FiArrowUpRight/></Link>
      </div>
    </div>
  );
};
