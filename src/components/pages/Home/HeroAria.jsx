        ...
        <div className="grid grid-cols-1 py-10 lg:grid-cols-2 md:items-center gap-0">
          <div className="lg:text-start w-auto lg:w-[800px]">
            ...
            <div className="text-[26px] flex flex-col lg:text-[45px]  xl:text-[45px] 2xl:text-[40px]  font-[1500] leading-none lg:text-start ">
              <h1>
                {language == "bn"
                  ? "কৃত্রিম বুদ্ধিমত্তা শেখার আগে,"
                  : "Before learning artificial intelligence,"}
              </h1>
              <h1 className="mt-4">
                {language == "bn"
                  ? "এর প্রতি আগ্রহ তৈরি করাটাই মূখ্য!"
                  : "It is important to create interest in it!"}
              </h1>
            </div>
            ...
            <h4 className="text-[16px] text-red-600 font-bold my-[15px] lg:w-[80%]  ">
              {language == "bn"
                ...
                : "Build a Career Become an Artificial Intelligence Expert with AI Expert Careers."}
            </h4>
            <div className="flex flex-col md:flex-row  justify-start w-3/5 md:w-full md:items-center gap-8 mt-6">
              ...
              >
                ...
                <span className="relative text-sm font-medium text-white transition-colors  group-hover:text-red-600">
                  {language == "bn"
                    ? "ফ্রি সেমিনারে জয়েন করুন"
                    : "Register Now"}
                </span>
              </Link>
              <button
                onClick={() => setIsOpen(true)}
                className="px-[32px] py-[8px] hover:bg-red-600 border border-[#ED1B24] rounded-md text-black shadow-lg flex justify-between items-center gap-2"
              >
                <img src={WatchVideo} alt="" />
                <span>
                  {language == "bn" ? "আমাদের সম্পর্কে" : "Watch demo"}
                </span>
              </button>
            </div>
          </div>
