  ...
  return (
    <div>
      <div className="md:grid items-stretch md:mt-0 mt-4 grid-cols-2 gap-3">
        <div className="">
          <h1 className="text-[#FE0651] font-bold text-3xl">
            {language === "bn"
              ? "কর্পোরেট বা ক্যারিয়ার কনসালটেন্টের মাধ্যমে নিশ্চিত করুণ আপনার সঠিক জার্নিটা!"
              : "Confirm your right journey with a corporate or career consultant!"}
          </h1>
          <p className="mt-6 w-[80%]">
            {language === "bn"
              ...
              : "No matter what background you are a student or learner, the right roadmap can get you there. Can give top success. Our AI roadmap and consultancy services are developed by these experts in various fields Whether you are a student or learner from any background, The Right Roadmap can help you"}
          </p>
        </div>
        <div className="">
          <Swiper
                ...
                >
                  <div className="lg:flex p-6 bg-[#fff] lg:divide-x-2 divide-[#000000d7] shadow-lg">
                    <div className="flex flex-col text-center lg:w-[40%] lg:px-10">
                      <img
                        className="lg:w-[130px] h-[130px] rounded-full border-[2px] p-1 border-dashed border-[red] mx-auto"
                        src={itm?.img}
                        alt=""
                      />
                    ...
                    <div className="lg:flex flex-col justify-between lg:w-[60%] lg:px-10 mt-5 lg:mt-0">
                      ...
                      <p className="text-[#515151]/90">{itm?.Speciality}</p>
                      <h2 className="text-[17px] font-bold">Place </h2>
                      <p className="text-[#515151]/90">{itm?.Place}</p>
