        ...
        <div className="md:flex mt-[70px] justify-center md:gap-x-[30px]  px-3 lg:px-0">
          <div className="w-full md:w-[448px]  border-[0.5px] border-black py-[33px] px-11 h-fit">
            <div className="flex items-center">
              <h2 className="font-bold text-xl md:text-[24px]">
                Order ID MMS99000047
              </h2>
          ...
          <div className="w-full md:w-[513px] mt-[30px] md:mt-0 border-[0.5px] border-black py-[33px] px-5">
            ...
            <div
              onClick={() => setIsBkash("bkash")}
              className="border cursor-pointer border-black flex items-center justify-between mt-11"
            >
            ...
            <div className="flex items-center mt-7 ">
              ...
              <p
                onClick={() => setValid(!valid)}
                className="font-bold cursor-pointer read-only"
              >
            ...
            <div className="flex justify-center items-center mt-5">
              {!valid && (
                <button
                  className="px-[94px] py-[13px] bg-[#ff094299] rounded text-white text-sm font-bold"
                  disabled
                >
                  {language == "bn" ? "এগিয়ে যান" : "Continue payment"}
                </button>
              )}
              {valid && (
                <button className="px-[94px] py-[13px] bg-[#FF0944] rounded text-white text-sm font-bold">
                  {language == "bn" ? "এগিয়ে যান" : "Continue payment"}
                </button>
              )}
            </div>
