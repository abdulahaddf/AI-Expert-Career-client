    ...
    <div className="px-4 pt-2 pb-20 mt-20 mx-auto max-w-full md:max-w-full lg:max-w-screen-xl xl:max-w-screen-xl 2xl:max-w-screen-2xl md:px-24 lg:px-20 2xl:px-8">
      <header className="py-20">
        <h1 className="font-bold text-[35px] text-center">
          Make an Appointment of Consultancy
        </h1>
        ...
        <form>
          <div className="">
            ...
            <input
              ...
              type="text"
              name="name"
              className="border px-2 mt-3 py-2 w-full rounded border-[red]"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-8">
            ...
            <div className="">
              <label htmlFor="appointmentTime" className="font-bold">
                Appointment Time
              </label>{" "}
              <br />
              <input
          ...
          <div className="mt-8">
            <label htmlFor="formFileLg" className="font-bold">
              Upload File
            </label>{" "}
            <br />
            <div className="mb-3">
          ...
          <div className="mt-8">
            ...
            <div className="mb-3">
              <textarea
                placeholder="Enter your case summary"
                type="text"
                name="department"
                className="border px-2 h-[260px] mt-3 py-2 w-full rounded border-[red]"
              />
            </div>
          </div>
          <button className="bg-[#F6002C] text-white flex justify-center items-center w-[170px] h-[50px] rounded-lg float-right">
            Submit
          </button>
          <br />
        </form>
