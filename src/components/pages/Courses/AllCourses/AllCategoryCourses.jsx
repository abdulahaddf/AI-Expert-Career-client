...
const AllCategoryCourses = () => {
  ...
  return (
    <div className="w-11/12 mx-auto mb-10">
      ...
      {
        paginatedCourses.length > 0 ? <><div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 justify-center">
      ...
      {/* pagination */}
      {
        paginatedCourses.length > 12 ? <div className="flex justify-center mt-8">
        <button
      ...
      </> : <div><h3 className="text-3xl h-[40vh] flex justify-center items-center">No Course Available Yet</h3></div>
      }
