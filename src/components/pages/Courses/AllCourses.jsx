...
console.log(courses)
  ...
  return (
    <div className="">
      <h2 className="text-[30px] font-bold text-center pb-[15px]">
        {language == "bn"
      ...
      <div className="mb-12 ">
        ...
        <h2 className="text-[30px] font-bold text-center lg:text-left lg:pl-28">
          {language == "bn" ? "ফ্রি কোর্সসমূহ" : "Free course"}
        </h2>
                ...
                {machineLearning.isFree ? (
                  <div className="flex justify-center">
                    <Link
                      ...
                      className="px-[26px] mt-6 py-3 text-white bg-[#FF265A]/90 font-semibold rounded-[10px]"
                    >
        ...
        <div className="w-40 flex justify-center h-12 text-center pb-[20px] mt-10 mx-auto group relative inline-bloc shadow-lg shadow-gray-600 rounded overflow-hidden border border-[#ED1B24] px-2 py-2 bg-red-600 focus:outline-none focus:ring">
          ...
          <Link
            to="/free_courses"
            className="relative text-xl font-bold text-white transition-colors  group-hover:text-red-600"
          >
