...
<div className="space-y-4">
  ...
  >
    ...
    <p className="mt-4 leading-relaxed text-gray-700">
      ...
      earum similique!
          ...
          <div>
            <span className="lg:text-2xl font-bold">
              {language == "bn" ? "কোর্স মডিউল" : "Course Contents"}
            </span>
                          ...
                          <Disclosure.Button className="w-full flex space-x-3 lg:flex items-center justify-between px-4 pb-6 text-left border-b-2 border-dashed border-black">
                            ...
                            <div className="flex gap-4">
                              <div className="w-20 lg:w-40 text-center group relative inline-bloc shadow-lg shadow-gray-600 rounded overflow-hidden border border-[#ED1B24] px-2 py-2 bg-red-600 focus:outline-none focus:ring">
                                <span className="absolute inset-y-0 left-0 w-[2px]  bg-[#ffffff] transition-all group-hover:w-full"></span>
          ...
          <div className="mt-[55px]">
            <h4 className="mb-4 lg:text-2xl font-bold">
              {language == "bn" ? "কোর্স ইন্সট্রাক্টর" : "Instructor"}
            </h4>
          ...
          <div>
            <div>
              <h2 className="mt-8 lg:text-2xl font-bold">
                {language == "bn" ? "পেমেন্ট সম্পন্ন করুন" : "Payment Accept"}
              </h2>
          ...
          <div className="mt-[35px]">
            <h2 className="font-bold lg:text-2xl">
              {language == "bn"
                ? "প্রয়োজনীয় স্কিল ও উপকরণ"
                : "Necessary Skills and Elements"}
            </h2>
            <div className="rounded-tr-[10px] rounded-bl-[10px] bg-white lg:w-[692px] mt-4">
              <div className="grid gap-y-3 p-5">
                {earnCertificates.map((certificate, i) => (
          ...
          <div>
            <h2 className="font-bold lg:text-2xl mt-[35px]">
              {language == "bn" ? "যেকোনো জিজ্ঞাসা" : "FAQ"}
            </h2>
            <div className=" rounded-tr-[10px] rounded-bl-[10px] bg-white lg:w-[692px] mt-4">
              {faqs?.map((faq, i) => (
                <div key={i} className="pt-5 ">
      ...
      {/* Related Course  */}
      <div>
        <h2 className="lg:text-2xl font-bold mt-10">
          {language == "bn"
            ? "উক্ত কোর্স সম্পর্কিত আরো কোর্সসমূহ"
            : "Related Courses"}
        </h2>
