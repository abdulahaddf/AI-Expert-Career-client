  ...
  return (
    <div className="my-12">
      <div className="flex items-center gap-3 py-5">
        ...
        <EventTitle
          title={language == "bn" ? "সাম্প্রতিক ইভেন্ট সমূহ" : "Resent Event"}
        />
      </div>
        ...
        {resendEventData?.slice(0, visibleItems)?.map((data, index) => (
          <div key={index} className="bg-[white] p-3 rounded-xl">
            ...
            >
              <a
                href="#eventHome"
                className=" absolute top-0 bg-[] flex items-center justify-center left-0 right-0 bottom-0"
              >
                {language == "bn" ? "দেখুন" : "Read more"}
              </a>
            </button>
          </div>
        ))}
