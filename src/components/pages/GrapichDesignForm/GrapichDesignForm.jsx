...
const GrapichDesignForm = () => {
  ...
  return (
    <div className="h-screen bg-[#F3F2FF]">
      <h1 className="text-center font-bold text-[35px] mt-[100px]">
        Graphic Design
      </h1>{" "}
      <br />
      <div className="bg-[white] rounded border w-[592px] m-auto  px-6 py-8">
        <form>
          <div className="">
            ...
            <input
              type="text"
              className="border-b border-[gray] w-full outline-none mt-2"
          ...
          <div className="flex justify-center mt-20">
            <button className="mt-8 bg-[#ED1B24] text-white px-8 py-2 rounded-lg">
              Submit
            </button>
          </div>
        </form>
