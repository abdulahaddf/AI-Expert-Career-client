  ...
  return (
    <div className=" md:grid grid-cols-2  mt-[70px]">
      <div className=" flex justify-center items-center">
        <div className="lg:px-[82px] px-[30px]">
          <div className="flex w-full justify-between">
            <h3 className="text-xl font-semibold text-[#ED1B24]">
              {language == "bn" ? "যোগাযোগ করুন" : "Contuct us"}
            </h3>
            <img src={circle} alt="" />
          </div>
          <h1 className="text-[35px] font-bold text-black/90 mt-[12px]">
            {" "}
            {language == "bn"
              ? "যেকোনো জিজ্ঞাসা বা প্রয়োজনে আমাদের জানান,"
      ...
      <div className="  mt-[50px] lg:mt-0 relative">
        <form
          action=""
          className="space-y-5  lg:w-2/3 bg-[#ED1B24]/10 md:ml-[80px] py-[50px] md:px-12 px-3"
        >
          <div>
            <input
              placeholder="Your Name"
              type="text"
              className="block  bg-[white] rounded-lg py-[10px] px-5 outline-none w-full"
            />
          </div>
          <div>
            <input
          ...
          <div>
            <textarea
              ...
              className=" block w-full py-3 px-5 outline-none rounded-[5px] bg-[white] rounded-lg"
            ></textarea>
          </div>
          ...
          <img
            src={Polygon2}
            alt=""
            className="absolute bottom-0 lg:right-20 -right-16"
          />
