  ...
  const instructorsDetails = [
    {
      ...
      aboutBN:
        "আপনি যেকোনো বেকগ্রাউন্ডের স্টুডেন্ট বা লার্নার হোন না কেনো, সঠিক রোডম্যাপ পারে আপনাকে আপনাকে পৌছে",
    },
    {
      Name: "Jane Cooper",
      photo: instrImg2,
  ...
  return (
    <div className="mt-[70px] p-4">
      <h1 className="text-center text-[35px] font-bold">
        {language == "bn"
          ? "এ আই এক্সপার্টস ও ইন্সট্রাক্টরস"
          : "AI Experts & Instructors"}
      </h1>
      <p className="text-center md:w-[500px] m-auto">
        {language == "bn"
      ...
      <div className=" grid  grid-cols-2 lg:grid-cols-3 gap-4 ">
        {instructorsDetails.map((instruct, i) => (
          <div key={i} className="text-center">
            ...
            <p className="text-justify mt-7 text-[8px] md:text-xl  font-medium">
              {language == "bn" ? instruct.aboutBN : instruct.aboutEN}
            </p>
          </div>
        ))}
      </div>
