    ...
    <div className="bg-gray-100 p-10">
      <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <p>
          ...
          conditions. Do not continue to use AI Expert Career if you do not agree
        ...
        <p>
          ...
          accessing AI Expert Career, you agreed to use the required cookies. A
          ...
          read by a web server in the domain that issued the cookie to you. We may
          use cookies to collect, store, and track information for statistical or
          marketing purposes to operate our website. You have the ability to
          accept or decline optional Cookies. There are some required Cookies
          that are necessary for the operation of our website. These cookies do
          not require your consent as they always work. Please keep in mind that
          by accepting required Cookies, you also accept third-party Cookies,
          which might be used via third-party provided services if you use such
          services on our website, for example, a video display window provided
          by third parties and integrated into our website.
        </p>
        <h2 className="text-xl font-semibold mt-4">License:</h2>
        <p>
          Unless otherwise stated, AI Expert Career and/or its licensors own the
          intellectual property rights for all material on AI Expert Career. All
          intellectual property rights are reserved. You may access this from AI
          Expert Career for your own personal use subjected to restrictions set
          in these terms and conditions. You must not:
        </p>
        <ul className="list-disc pl-6 mt-2">
          <li>Copy or republish material from AI Expert Career</li>
          <li>Sell, rent, or sub-license material from AI Expert Career</li>
          <li>Reproduce, duplicate or copy material from AI Expert Career</li>
          <li>Redistribute content from AI Expert Career</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <h2 className="text-xl font-semibold mt-4">Parts of this website:</h2>
        <p>
          offer users an opportunity to post and exchange opinions and information
          in certain areas of the website. AI Expert Career does not filter, edit,
          publish or review Comments before their presence on the website.
          Comments do not reflect the views and opinions of AI Expert Career, its
          ...
          by applicable laws, AI Expert Career shall not be liable for the
          ...
          Comments on this website. AI Expert Career reserves the right to monitor
          all Comments and remove any Comments that can be considered
        ...
        <p>You hereby grant AI Expert Career a non-exclusive license to use, reproduce, edit, and authorize others to use, reproduce, and edit any of your Comments in any and all forms, formats, or media.</p>
        <h2 className="text-xl font-semibold mt-4">Hyperlinking to our Content:</h2>
        <p>
        ...
        <ol className="list-decimal pl-6 mt-2">
          ...
          <li>
            ...
            absence of AI Expert Career; and
          </li>
        ...
        <p>
          ...
          e-mail to AI Expert Career. Please include your name, your organization
        ...
        <h2 className="text-xl font-semibold mt-4">Content Liability:</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-4">Reservation of Rights:</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-4">Removal of links from our website:</h2>
        <p>
          ...
          to you directly. We do not ensure that the information on this website is
          correct. We do not warrant its completeness or accuracy, nor do we
          promise to ensure that the website remains available or that the material
        ...
        <p>
          ...
          duty. As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.
        </p>
      </div>
    </div>
  );
