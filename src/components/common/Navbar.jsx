          ...
          <div className="relative flex items-center justify-between font-bold">
            {
              <ul className="md:flex block items-center">
                ...
                <Link
                  to={"/home"}
                  className="lg:hidden md:block block w-[90px]"
                >
                  <img
            ...
            <div className="lg:flex md:hidden justify-between items-center gap-5">
              <ul className="items-center hidden font-[700] lg:flex">
                <div
                  className={`flex items-center absolute bg-[#FA111B] bottom-[-40px] left-0 right-0 mx-auto w-[70px]  h-[70px] rounded-full justify-center opacity-0 transition-opacity ease-linear ${
                    scrollNav && "opacity-100"
                  } `}
                >
                  <Link to="">
                    <img
