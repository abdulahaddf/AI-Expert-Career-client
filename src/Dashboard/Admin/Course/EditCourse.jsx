...
const removeCollaborators = (CollaboratorToRemove) => {
  ...
  const updatedCollaborators = selectedCollaborators.filter((Collaborator) => Collaborator !== CollaboratorToRemove);
    ...
    <div className="container max-w-4xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        ...
        <div className="mb-4">
          ...
          <input {...register('title')} type="text" id="title" className="border border-gray-300 rounded-xl p-2" />
        </div>
        <div className="mb-4">
            <label
              htmlFor="imageURL"
...
/>
        ...
        <div className="mb-4">
          <label htmlFor="subtitle" className="block  mb-1">Course Sub-Title:</label>
          <input {...register('subtitle')} type="text" id="subtitle" className="border border-gray-300 rounded-xl p-2 w-full" />
        </div>
{/* Course Description */}
            <div className='my-5'>
            <p className="block font-semibold text-2xl mb-4">Course Description:</p>
            <JoditEditor
            id="description"
            ref={editor}
        ...
        <div className="mb-4">
          ...
          <input {...register('duration')} type="number" id="duration" className="border border-gray-300 rounded-xl p-2 md:w-64" />
        </div>
         </div>
...
{/* Instructor Profile */}
        ...
        <div className="mb-4">
          ...
          <input {...register('insDescription')} type="text" id="insDescription" className="border border-gray-300 rounded-xl p-2 w-full " />
        </div>
        <div className="mb-4">
          <label htmlFor="insImage" className="block mb-2 font-medium text-gray-700">Instructor Photo URL:</label>
          <input {...register('insImage')} type="url" id="insDesignation" className="border border-gray-300 rounded-xl p-2 w-full" />
        </div>
        </div>
    ...
    <DriveLinkConverter/>
       ...
       <div className='my-10'>
            ...
            {module.contents &&
              module.contents.map((content, contentIndex) => (
                <div key={contentIndex} className="border border-gray-300 rounded-xl p-4 mb-4">
                  ...
                  <h3 className="text-lg font-semibold mb-2">{content.type} {contentIndex + 1}</h3>
                  <button
                    type="button"
                    onClick={() => removeContentWithType(moduleIndex, contentIndex)}
                  ...
                  <div className="mb-4">
                    <label htmlFor={`modules[${moduleIndex}].contents[${contentIndex}].title`} className="block font-semibold mb-1">{content.type} Title:</label>
                    <input
                      {...register(`modules[${moduleIndex}].contents[${contentIndex}].title`)}
                      type="text"
                      className="border border-gray-300 rounded-xl p-2 w-full"
                    />
                  </div>
        ...
        <button type="submit" className="my-btn bg-primary btn-md rounded-lg">
            {isLoading ? <p className='flex items-center gap-2 text-white'>Uploading <span className="loading loading-spinner text-error"></span></p> : "Update"}
