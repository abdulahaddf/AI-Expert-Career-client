...
/>
        ...
        <div className="mb-4">
          ...
          <input {...register('subtitle', { required: true })} type="text" id="subtitle" className="border border-gray-300 rounded-xl p-2 w-full" />
        </div>
{/* Course Description */}
            <div className='my-5'>
...
{/* Instructor Profile */}
        ...
        <div className="mb-4">
          ...
          <input {...register('insImage', { required: true })} type="url" id="insDesignation" className="border border-gray-300 rounded-xl p-2 w-full" />
        </div>
        </div>
